...
export const TREASURE_HUNT_TASKS = [
  ...
  },
  {
    ...
    validationPrompt: "Does this img clearly show a spoon? Respond with YES or NO.",
  ...
  },
  {
    ...
    validationPrompt: "Does this image clearly show a cup, mug, or drinking vessel? Respond with YES or NO.",
  ...
  },
  {
    ...
    validationPrompt: "Does this image clearly show a plate, dish, or flatware? Respond with YES or NO.",
  ...
  },
  {
    ...
    validationPrompt: "Does this image clearly show a knife or cutting utensil? Respond with YES or NO.",
