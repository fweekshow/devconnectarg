...
export const getFullSchedule = tool(
  ...
  },
  {
    ...
    description: "Use this tool to get schedule data for DevConnect 2025 (Nov 15-23, 2025). Returns schedule data that the AI will search through to answer the user's question. Use searchAllDays=true when user asks about: SPECIFIC EVENTS/ACTIVITIES by name (like 'When is Staking Summit'), TOP/BIGGEST/BEST events across all days (like 'biggest events', 'top events'), or recommendations across multiple days. Use day parameter when user asks about a SPECIFIC DAY (like 'Monday schedule', 'What's on Tuesday'). Leave both empty for today's schedule.",
    schema: z.object({
